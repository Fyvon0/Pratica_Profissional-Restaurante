...
public class Questionarios {
	 ...
	 * 
	 * @param codigo	código de questionário a ser procurado no banco de dados
	...
	/**
    * Retorna as informações do questionário com o código informado
    * 
    * @param codigo	o código do questionário que será procurado no banco de dados
    * @return	uma instância da classe Questionário cujo código seja igual ao parâmetro
    ...
    */
    ...
    /**
     * Retorna todas os questionários do banco de dados
     * 
     * @return	uma instância de MeuResultSet com todas os questionários do banco de dados
